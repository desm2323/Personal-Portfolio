/* Hand-built inline SVG icon set (Lucide-style: 24px grid, round caps,
   stroke inherits currentColor). All icons are decorative by default —
   aria-hidden — so pair them with visible text or an aria-label. */

const Icon = ({ size = '1em', strokeWidth = 1.75, className, children, ...rest }) => (
    <svg
